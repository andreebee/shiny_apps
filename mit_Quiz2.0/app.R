...
ui <- shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        conditionalPanel(
            ...
            conditionalPanel("input.submit!=0",   #Button geklickt
                             conditionalPanel("input.quiz1 === 'Eine kleine Differenz der Mittelwerte erzeugt einen großen p-Wert'",   #richtige Antwort gegeben
                                             # conditionalPanel("input.submit!=0",   #Button geklickt mehr als 0 mal
                                             HTML(paste0("<b>", "Erklärung:", "</b>")),
                                               paste0(
                                                   "  Der Effekt ist einmal in dem Boxplot zu erkennen,
        ...
        conditionalPanel(
            ...
            actionButton("vorher2", label = "Vorheriges Tab"),
            
            #Erklaerung
            conditionalPanel("input.submit2==1" ,   #Butten geklickt
        ...
        conditionalPanel(
            ...
            actionButton("vorher3", label = "Vorheriges Tab"),
            
            #Erklaerung
            conditionalPanel("input.submit3==1" ,   #Butten geklickt
    ...
    mainPanel(
        ...
        tabsetPanel(
            ...
            tabPanel(
                ...
                value = "1",
                #Sidebar 1 wird eingeblendet, Value in "" damit man in das naechste Tab springen kann
    ...
    Stichproben ändert. ",
                ...
                #Button um ins naechste Tab zu springen
                uiOutput("Button1")
            ),
            #Ende TabPanel
            ...
            tabPanel(
                ...
                value = "2",
                #Sidebar 2 wird eingeblendet
                #value = "diff und sd",
                conditionalPanel(
                    "input.quiz1 === 'Eine kleine Differenz der Mittelwerte erzeugt einen großen p-Wert'",
                    #Bedingung, wann der Inhalt angezeigt wird
            ...
            tabPanel(
                title = "",
                # "Differenz, Standardabweichung und Anzahl",
                value = "3",
                #Sidebar 3 wird eingeblendet
                
                conditionalPanel(
                    "input.quiz2 === 'Eine große Änderung der Standardabweichung erzeugt einen großen p-Wert'",
                    #Bedingung, wann der Inhalt angezeigt wird
            ...
            tabPanel(
                ...
                value = "4",
                conditionalPanel(
                    "input.quiz3 === 'Ein p-Wert < 0.05 ist signifikant'",
                    titlePanel("Ergebnis"),
                    "Super!!!"
                )
            ),
