...
ui <- shinyUI(pageWithSidebar(
    ...
    Stichproben ändert. ",
                    ...
                    tabPanel(title = "" ,#"Differenz und Standardabweichung",
                    ...
                    tabPanel(title = "", # "Differenz, Standardabweichung und Anzahl",
                    ...
                    tabPanel(" ",
                             value = "4",
                            conditionalPanel( "input.quiz3 === 'Ein p-Wert < 0.05 ist signifikant'",
                                              titlePanel("Ergebnis"),
                             "Super!!!"
                             )
                    ),
