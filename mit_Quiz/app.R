...
ui <- shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        conditionalPanel(condition = "input.tabselected ==1", 
                         ...
                         selectInput(
                             ...
                             selected = NULL,
                             choices=c( "Affen sind Pflanzen",
                                        "Hammerhai können fliegen",
                                        "Kühe sind nicht lila",
                                        "p-Werte brauchte kein Mensch",
                                        "a"))
                         ),   #Ende.....
        ...
        conditionalPanel(condition="input.tabselected ==2",
                         ...
                         selectInput(
                             ...
                             choices=c("Die Änderung der Differenz des Mittelwertes hat keine Auswirkung",
                                       "Die Änderung hat eine sehr große Auswirkung auf den p-Wert",
                                       "Kühe sind nicht gelb",
                                       "Die Änderung hat eine mittelmäßige auswirkung auf den p-Wert",
                                       "b"))
        ),
    ...
    mainPanel(
        ...
        tabsetPanel(type = "tabs",
            ...
            tabPanel(
                ...
                #  conditionalPanel("input.quiz1 === 'Kühe sind nicht lila'",
    ...
    Stichproben ändert. ",
            ...
            conditionalPanel(
                "input.quiz1 === 'Kühe sind nicht lila'",
                #ist dann auch in Tab2 zusehen, weil es die gleiche Bedingung hat, man koennte zwei Fragen machen, eine um die Erklaerung zu sehen und eine um die Ausgabe im naechsten tab zu sehen
    ...
    Standardabweichung ändert. Gruppe 1 bleibt fest. ",
          ...
          tabPanel("Differenz, Standardabweichung und Anzahl",
            ...
            conditionalPanel("input.quiz3 === 'Kühe sind nicht rot'",
